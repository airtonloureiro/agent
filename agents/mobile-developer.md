...
model: inherit
skills: clean-code, mobile-design, react-native-architecture, react-patterns, react-state-management, react-best-practices, typescript-pro, typescript-advanced-types, ui-skills, ui-ux-designer
---
